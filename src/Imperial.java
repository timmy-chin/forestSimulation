...
public abstract class Imperial extends StarWarsChar{

    public Imperial(String id, Point position, double actionPeriod, double animationPeriod, List<PImage> images, List<List<PImage>> imageType, int health) {
    ...
    public void executeActivity(WorldModel world, ImageStore imageStore, EventScheduler scheduler) {
        ...
        Optional<Entity> target = world.findNearest(this.getPosition(), new ArrayList<>(List.of(DudeNotFull.class, DudeFull.class, Fairy.class, KirstenSkywalker.class, AntoBiWan.class,  Zuko.class, Kendama.class)));
    ...
    public void StarWarsCharDeath(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        if (this.getHealth() <= 0) {
            ...
            target = world.findRandom(this.getPosition(), new ArrayList<>(List.of(BadShip.class)));
